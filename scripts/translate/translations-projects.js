export const translationsProjects = {
  ...
  'en-US': [
    ...
    {
      description: 'Complete development of a modern landing page for an automotive body repair and painting company. Includes service sections, portfolio of completed work, integrated contact form, and SEO optimization for local visibility.',
    },
    {
  ...
  'es-ES': [
    ...
    {
      description: 'Desarrollo completo de landing page moderna para empresa especializada en chapistería y pintura automotriz. Incluye secciones de servicios, portafolio de trabajos realizados, formulario de contacto integrado y optimización SEO para mayor visibilidad local.',
    },
    {
